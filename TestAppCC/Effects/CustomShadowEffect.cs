...
namespace TestAppCC.Effects
{
    ...
    {
        public CustomShadowEffect() : base($"Effects.{nameof(CustomShadowEffect)}")
        {
        }
    }
    ...
    public static class ShadowEffect
    {
        ...
        static void OnHasShadowChanged(BindableObject bindable, object oldValue, object newValue)
        {
            ...
            if (hasShadow)
            {
                view.Effects.Add(new CustomShadowEffect());
            }
            else
            {
                var toRemove = view.Effects.FirstOrDefault(e => e is CustomShadowEffect);
                if (toRemove != null)
                {
